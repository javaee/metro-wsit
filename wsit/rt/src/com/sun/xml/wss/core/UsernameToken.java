/*
 * $Id: UsernameToken.java,v 1.1 2006-05-03 22:57:34 arungupta Exp $
 */
...
implements SecurityToken, Token {
            ...
            if (object.getNodeType() == Node.ELEMENT_NODE) {
                ...
                XMLUtil.inWsseNS(element)) {
                    ...
                    if (isBSP() && passwordType.length() < 1) {
                        ...
                        new XWSSecurityException(" A wsse:UsernameToken/wsse:Password element in a SECURITY_HEADER MUST specify a Type attribute.");
                    }
    ...
    public Object getTokenValue() {
        throw new UnsupportedOperationException("Not yet implementedr");
    }
}
