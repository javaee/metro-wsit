        ...
        while(itr.hasNext()){
            ...
            if(ref.getURI().length() >0){
                ...
                if(se != null){
                    ...
                    throw new XWSSecurityException("Signature verification failed: Element with " + Id
...
//                    }
                    ...
                    try{
                        ...
                        logger.log(Level.FINEST,"Error occurred while" +
                                "resolving XPATH expression"+expr,xpe);
...
//                        transformList.add(transform);
                        ...
                        /*else{
                            ...
                            emptyList.add("");
                            spec = new ExcC14NParameterSpec(emptyList);
                        }*/
                        Transform transform = signatureFactory.newTransform(transformAlgo,spec);
                        transformList.add(transform);
                    }
    ...
    private String generateReferenceID(Element secElement, SecurableSoapMessage securableSoapMessage) {
        ...
        if(MessageConstants.debug){
            System.out.println("Element wsu:id attribute is: "+id);
        }
        return id;
    }
