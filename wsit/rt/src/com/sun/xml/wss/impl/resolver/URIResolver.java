/*
 * $Id: URIResolver.java,v 1.1 2006-05-03 22:57:59 arungupta Exp $
 */
...
public class URIResolver extends ResourceResolverSpi {
  ...
  private XMLSignatureInput _resolveId(Attr uri, String baseUri) 
    ...
    */
    ...
    private final class URIResolverException extends Exception {};

    private final int ID_REFERENCE  = 0;
    private final int CID_REFERENCE = 1;
    private final int CLOCATION_REFERENCE  = 2;
