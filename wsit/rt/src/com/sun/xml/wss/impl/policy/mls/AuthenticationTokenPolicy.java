/*
 * $Id: AuthenticationTokenPolicy.java,v 1.1 2006-05-03 22:57:54 arungupta Exp $
 */
...
public class AuthenticationTokenPolicy extends WSSFeatureBindingExtension {
    ...
    public static class UsernameTokenBinding extends KeyBindingBase {
         ...
         */
        public UsernameTokenBinding(String username,
                String password,
                String nonce,
                boolean doDigest,
                String creationTime) {
        ...
        public MLSPolicy newTimestampFeatureBinding() throws PolicyGenerationException {
            ...
            if (!(_policyIdentifier == PolicyTypeUtil.USERNAMETOKEN_TYPE) &&
                ...
                throw new PolicyGenerationException(
                        "Can not create a feature binding of Timestamp type for " +
                        _policyIdentifier);
    ...
    public static class SAMLAssertionBinding extends KeyBindingBase {
         ...
         */
        public SAMLAssertionBinding(String type, String keyIdentifier,
                String authorityIdentifier, String referenceType) {
            this();
            this._type = type;
        ...
        public boolean equals(WSSPolicy policy) {
            ...
            try {
                ...
                boolean b2 = _authorityIdentifier.equals("") ? true:
                    _authorityIdentifier.equals(sBinding.getAuthorityIdentifier());
                if (!b2) return false;
