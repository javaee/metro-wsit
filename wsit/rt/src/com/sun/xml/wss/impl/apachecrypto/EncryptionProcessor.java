    ...
    public static void encrypt(FilterProcessingContext context) throws XWSSecurityException{
        ...
        if (PolicyTypeUtil.usernameTokenPolicy(keyBinding)) {
            ...
            if(!skb.getKeyIdentifier().equals(MessageConstants._EMPTY)){
                ...
                _x509Cert = certificateBinding.getX509Certificate();
                x509TokenId = certificateBinding.getUUID();
                //x509TokenId = certificateBinding.getPolicyToken().getTokenId();
                if(x509TokenId == null || x509TokenId.equals("")){
                    x509TokenId = secureMsg.generateId();
                }  
            ...
            try {
                if ( System.getProperty("com.sun.xml.wss.saml.binding.jaxb").equals("false") ||
                        System.getProperty("com.sun.xml.wss.saml.binding.jaxb") == null ) {
            ...
            Key key = null;
            if ( assertion1 != null ) {
                key = KeyResolver.resolveSamlAssertion(
                        context.getSecurableSoapMessage(), ((com.sun.xml.wss.saml.Assertion)assertion1), true, context, assertionID);
            } else if ( assertion2 != null ) {
                key = KeyResolver.resolveSamlAssertion(
                        context.getSecurableSoapMessage(), ((com.sun.xml.wss.saml.Assertion)assertion2), true, context, assertionID);
            }
            ...
            keyInfoStrategy.insertKey(samlTokenRef, secureMsg);
                ...
                includeIST = (com.sun.xml.ws.security.policy.Token.INCLUDE_ALWAYS_TO_RECIPIENT.
...
//        }
    ...
    private static void encryptAttachment( AttachmentPart part, boolean contentOnly, Cipher cipher) throws XWSSecurityException {
        try {
            ...
            part.setMimeHeader(MimeConstants.CONTENT_LENGTH,new Integer(cLength).toString());
