...
public class MessageConstants {
    ...
    public static int NOT_OPTIMIZED = 0 ;
    public static int SIGN_BODY = 1;
    public static int SIGN_ENCRYPT_BODY = 2;
    public static int ENCRYPT_SIGN_BODY =3;
    public static int SECURITY_HEADERS = 4;
    public static int ENCRYPT_BODY = 5;
    public static int SECURE_ATTACHMENTS = 6;
    public static int SECURITY_HEADERS_AND_ATTACHMENTS = 7;
    public static final boolean debug = false;
    public static int OCTECT_STREAM_DATA = 1;
    public static int NODE_SET_DATA = 2;
    public static int ATTACHMENT_DATA = 3;
