...
class FiberExecutor {
    ...
    synchronized void schedule(Packet request, @NotNull final Fiber.CompletionCallback callback) {
        schedules.add(new Schedule(request, callback));
    }

    synchronized void startScheduledFibers() {
    ...
    void start(Packet request, @NotNull final Fiber.CompletionCallback callback) {
