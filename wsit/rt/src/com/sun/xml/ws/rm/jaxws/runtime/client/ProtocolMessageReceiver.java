...
//    private static EndpointImpl endpoint;
    ...
    public static void handleAcknowledgement(SequenceAcknowledgementElement seqAckElement) throws RMException {
        ...
        if (seqAckElement.getId() == null) {
            throw new InvalidSequenceException(LocalizationMessages.WSRM_3022_UNKNOWN_SEQUENCE_ID_IN_MESSAGE(null), null);
        }
        OutboundSequence seq = RMSource.getRMSource().getOutboundSequence(seqAckElement.getId());
        seq.handleAckResponse(seqAckElement);
    }
}
