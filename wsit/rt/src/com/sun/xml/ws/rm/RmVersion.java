...
public enum RmVersion {
    ...
    com.sun.xml.ws.rm.protocol.wsrm200502.AcceptType.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.AckRequestedElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.CreateSequenceElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.CreateSequenceResponseElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.Expires.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.Identifier.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.OfferType.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.SequenceAcknowledgementElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.SequenceElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.SequenceFaultElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200502.TerminateSequenceElement.class),
    /**
     * <p>
    ...
    com.sun.xml.ws.rm.protocol.wsrm200702.AcceptType.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.AckRequestedElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.Address.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.CloseSequenceElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.CloseSequenceResponseElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.CreateSequenceElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.CreateSequenceResponseElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.DetailType.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.Expires.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.Identifier.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.IncompleteSequenceBehaviorType.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.MakeConnectionElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.MessagePendingElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.OfferType.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.SequenceAcknowledgementElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.SequenceElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.SequenceFaultElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.TerminateSequenceElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.TerminateSequenceResponseElement.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.UsesSequenceSSL.class,
    com.sun.xml.ws.rm.protocol.wsrm200702.UsesSequenceSTR.class);
