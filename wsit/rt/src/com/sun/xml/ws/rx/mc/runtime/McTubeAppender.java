 ...
 */
public class McTubeAppender implements TubeAppender {
    ...
    public Tube appendTube(WsitClientTubeAssemblyContext context) throws WebServiceException {
        McConfiguration configuration = createConfiguration(context.getWsdlPort(), context.getBinding(), context.getPolicyMap());
    ...
    public Tube appendTube(WsitServerTubeAssemblyContext context) throws WebServiceException {
        McConfiguration configuration = createConfiguration(context.getWsdlPort(), context.getEndpoint().getBinding(), context.getPolicyMap());
    ...
    private static McConfiguration createConfiguration(final WSDLPort port, final WSBinding binding, final PolicyMap policyMap) {
        ...
        try {
            ...
            return McConfigurationFactory.INSTANCE.createInstance(
                            rmf,
                            mcf,
                            port,
                            binding);
