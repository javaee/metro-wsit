...
public enum McConfigurationFactory {
    ...
    public McConfiguration createInstance(final ReliableMessagingFeature rmf, final MakeConnectionSupportedFeature mcf, final WSDLPort wsdlPort, final WSBinding binding) {
