...
class PacketFilteringTube extends AbstractFilterTubeImpl {
    ...
    public PacketFilteringTube(RmConfiguration configuration, Tube tubelineHead, WsitClientTubeAssemblyContext context) {
        super(tubelineHead);
    ...
    public PacketFilteringTube(RmConfiguration configuration, Tube tubelineHead, WsitServerTubeAssemblyContext context) {
        super(tubelineHead);
