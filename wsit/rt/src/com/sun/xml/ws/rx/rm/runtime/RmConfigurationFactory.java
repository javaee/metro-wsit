...
public enum RmConfigurationFactory {
    ...
    public RmConfiguration createInstance(final ReliableMessagingFeature rmf, final MakeConnectionSupportedFeature mcf, final WSDLPort wsdlPort, final WSBinding binding) {
