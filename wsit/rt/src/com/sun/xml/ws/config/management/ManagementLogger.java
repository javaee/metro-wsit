...
public class ManagementLogger extends Logger {
     ...
     */
    private static final String MANAGEMENT_PACKAGE_ROOT = "com.sun.xml.ws.config.management";
    private static final String MANAGEMENT_API_PACKAGE_ROOT = "com.sun.xml.ws.api.config.management";
