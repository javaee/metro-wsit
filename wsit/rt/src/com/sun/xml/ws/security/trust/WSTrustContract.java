 ...
 *  </head>
 *  <body>
 *    The Contract (SPI) to be used by an STS OR a WSP (engaging in a possibly 
 *    Multi-Message exchange) to handle an Incoming WS-Trust request and send 
 *    the corresponding response
 *  </body>
 * </html>
 */
public interface WSTrustContract   {

    public void init(Configuration config);
    /** Issue a Token */
    public RequestSecurityTokenResponse issue(
        RequestSecurityToken request, IssuedTokenContext context,SecureConversationToken policy)
    ...
    */
   boolean containsChallenge(RequestSecurityToken rst);
}
