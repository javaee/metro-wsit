/*
 * $Id: WSTrustElementFactoryImpl.java,v 1.7 2007-01-02 23:57:00 manveen Exp $
 */
...
public class WSTrustElementFactoryImpl extends WSTrustElementFactory {
    ...
    public  RequestSecurityToken createRSTFrom(Element elem) {
        try {
            ...
            log.log(Level.SEVERE,
                    LogStringsMessages.WST_0006_FAIL_RST_SOURCE(elem.toString(), ex));
            throw new RuntimeException(ex.getMessage(), ex);
        }
    }
    ...
    public  RequestSecurityTokenResponse createRSTRFrom(JAXBElement elem) {
        try {
            ...
            log.log(Level.SEVERE,
                    LogStringsMessages.WST_0010_FAILED_CREATION_FROM_JAXBELE("RSTR", e));
