...
public interface JmxConnectorServerCreator {
     ...
     *
     * @param serviceUrl The JMXServiceURL.
     * @param environment A map with key/value pairs that were passed in through
     *   the JmxConnectorServerEnvironment parameter in the ManagedService
     *   configuration.
     * @param server The MBeanServer for this JMX agent.
     * @return An instance of JMXConnectorServer. May not be null.
     * @throws WebServiceException If the creation of the JMXConnectorServer instance
     *   failed.
     */
    JMXConnectorServer create(JMXServiceURL serviceUrl, Map<String, String> environment, MBeanServer server)
