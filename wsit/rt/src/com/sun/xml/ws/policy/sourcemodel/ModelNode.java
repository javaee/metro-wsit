...
public final class ModelNode implements Iterable<ModelNode>, Cloneable {
    ...
    public static enum Type {
        ...
        boolean isChildTypeSupported(final Type childType) {
            switch (this) {
                ...
                default:
                    LOGGER.severe("isChildTypeSupported", LocalizationMessages.WSP_0060_MODEL_NODE_TYPE_UNKNOWN(this));
                    throw new IllegalStateException(LocalizationMessages.WSP_0060_MODEL_NODE_TYPE_UNKNOWN(this));
            }
        }
    }
    ...
    static ModelNode createRootPolicyNode(final PolicySourceModel model) throws NullPointerException {
        if (model == null) {
            LOGGER.severe("createRootPolicyNode", LocalizationMessages.WSP_0039_POLICY_SRC_MODEL_INPUT_PARAMETER_MUST_NOT_BE_NULL());
            throw new NullPointerException(LocalizationMessages.WSP_0039_POLICY_SRC_MODEL_INPUT_PARAMETER_MUST_NOT_BE_NULL());
        }
    ...
    private void checkCreateChildOperationSupportForType(Type type) throws UnsupportedOperationException {
        if (!this.type.isChildTypeSupported(type)) {
            final String message = LocalizationMessages.WSP_0073_CREATE_CHILD_NODE_OPERATION_NOT_SUPPORTED(type, this.type);
    ...
    void setParentModel(final PolicySourceModel model) throws IllegalAccessException {
        if (parentNode != null) {
            LOGGER.severe("setParentModel", LocalizationMessages.WSP_0049_PARENT_MODEL_CAN_NOT_BE_CHANGED());
            throw new IllegalAccessException(LocalizationMessages.WSP_0049_PARENT_MODEL_CAN_NOT_BE_CHANGED());
        }
    ...
    public AssertionData setOrReplaceNodeData(final AssertionData newData) {
        if (!isAssertionRelatedNode()) {
            LOGGER.severe("setOrReplaceNodeData", LocalizationMessages.WSP_0051_OPERATION_NOT_SUPPORTED_FOR_THIS_BUT_ASSERTION_RELATED_NODE_TYPE(type));
            throw new UnsupportedOperationException(LocalizationMessages.WSP_0051_OPERATION_NOT_SUPPORTED_FOR_THIS_BUT_ASSERTION_RELATED_NODE_TYPE(type));
        }
    ...
    void setReferencedModel(final PolicySourceModel model) {
        if (this.type != Type.POLICY_REFERENCE) {
            LOGGER.severe("setReferencedModel", LocalizationMessages.WSP_0050_OPERATION_NOT_SUPPORTED_FOR_THIS_BUT_POLICY_REFERENCE_NODE_TYPE(type));            
            throw new UnsupportedOperationException(LocalizationMessages.WSP_0050_OPERATION_NOT_SUPPORTED_FOR_THIS_BUT_POLICY_REFERENCE_NODE_TYPE(type));
        }
