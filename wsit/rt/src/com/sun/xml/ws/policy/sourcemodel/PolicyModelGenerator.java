...
public final class PolicyModelGenerator {
    ...
    public PolicySourceModel translate(final Policy policy) throws PolicyException {
        ...
        if (policy == null) {
            LOGGER.fine("translate", LocalizationMessages.WSP_000047_POLICY_IS_NULL_RETURNING());
        } else {
    ...
    private void translate(final Iterator<PolicyAssertion> assertionParametersIterator, final ModelNode assertionNode) {
        while (assertionParametersIterator.hasNext()) {
            ...
            if (assertionParameter.hasNestedPolicy()) {
                LOGGER.severe("translate", LocalizationMessages.WSP_000005_UNEXPECTED_POLICY_ELEMENT_FOUND_IN_ASSERTION_PARAM(assertionParameter));
                throw new IllegalStateException(LocalizationMessages.WSP_000005_UNEXPECTED_POLICY_ELEMENT_FOUND_IN_ASSERTION_PARAM(assertionParameter));
            }
