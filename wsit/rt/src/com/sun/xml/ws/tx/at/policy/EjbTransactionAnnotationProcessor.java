 ...
 */
public final class EjbTransactionAnnotationProcessor {
     ...
     */
    public static EjbTransactionAttributeType getTransactionAttributeDefault(Class c) {
        // defaults to REQUIRED if no annotation on class
        EjbTransactionAttributeType result = EjbTransactionAttributeType.REQUIRED;
     ...
     */
    public static EjbTransactionAttributeType getEffectiveTransactionAttribute(Method m, EjbTransactionAttributeType defaultTxnAttr) {
        EjbTransactionAttributeType result = defaultTxnAttr;
    ...
    private static EjbTransactionAttributeType convert(javax.ejb.TransactionAttributeType e) {
        return EjbTransactionAttributeType.valueOf(EjbTransactionAttributeType.class, e.name());
    }
}
