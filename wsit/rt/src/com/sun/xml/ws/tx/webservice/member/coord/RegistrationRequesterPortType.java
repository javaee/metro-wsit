 ...
 */
@WebService(name = "RegistrationRequesterPortType",
...
public interface RegistrationRequesterPortType {
    ...
    @Oneway
    @Action(input = "http://schemas.xmlsoap.org/ws/2004/10/wscoor/RegisterResponse")
    public void registerResponseOperation(
            @WebParam(name = "RegisterResponse", targetNamespace = "http://schemas.xmlsoap.org/ws/2004/10/wscoor", partName = "parameters") RegisterResponseType parameters);
