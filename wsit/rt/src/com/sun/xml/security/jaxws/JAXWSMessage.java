 ...
 * JAXWSMessage.java
 *
 * Created on August 4, 2005, 2:08 PM
 */
...
public class JAXWSMessage {
    ...
    public void writeSOAPMessage( OutputStream baos ) throws XMLStreamException, SOAPException, IOException{
        ...
        if(!isBodyUsed()){
            ...
            SOAPBody body1 = env.getBody();
            if(body1.getNodeType() == Node.ELEMENT_NODE){
    ...
    public void writeJAXWSHeaders(XMLStreamWriter writer) throws SOAPException{
        InternalSoapEncoder encoder1 = getEncoder();
        Object messageInfo1= getMessageInfo();
        ...
        for(int i=0;i<headers.size();i++){
            ...
            encoder1.write(internalHeader,messageInfo1,writer,mtomCB);
        }
    }
    ...
    public void writeJAXWSBody(OutputStream stream) throws IOException,SOAPException{
        ...
        Object body1 = getBody();
        if(stream != null ){
            if(body != null){
                encoder1.write(body1,messageInfo1,stream,mtomCB);
            }
        }else{
    ...
    public void writeJAXWSBody(XMLStreamWriter writer){
        ...
        encoder1.write(body1,messageInfo1,writer, mtomCB);
    }
    ...
    private static void setMimeHeader(com.sun.xml.ws.spi.runtime.SOAPMessageContext msgContext,SOAPMessage sm){
        ...
        //end
        if(soapVersion.equals(javax.xml.ws.soap.SOAPBinding.SOAP11HTTP_BINDING)){
