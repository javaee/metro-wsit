...
public class LoggerTest extends TestCase {
    ...
    public void testGetSubsystemName() {
        ...
        result = Logger.getSystemLoggerName(com.sun.xml.ws.api.security.trust.BaseSTS.class);
        assertEquals("javax.enterprise.resource.webservices.security", result);

        result = Logger.getSystemLoggerName(com.sun.xml.ws.security.trust.TrustPlugin.class);
        assertEquals("javax.enterprise.resource.webservices.security", result);

        result = Logger.getSystemLoggerName(com.sun.xml.wss.provider.wsit.AuthParam.class);
        assertEquals("com.sun.xml.wss.provider.wsit", result);
    }
