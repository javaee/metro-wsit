 ...
 * 
 */
@WebServiceClient(name = "SecurityTokenService", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/C:/metro/WSIT/wsit/wsit/test/e2e/testcases/wstrust/multiple/sts/sts.wsdl")
public class SecurityTokenService
    extends Service
{

    private final static URL SECURITYTOKENSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(wstrust.multiple.sts.SecurityTokenService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = wstrust.multiple.sts.SecurityTokenService.class.getResource(".");
            url = new URL(baseUrl, "file:/C:/metro/WSIT/wsit/wsit/test/e2e/testcases/wstrust/multiple/sts/sts.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/C:/metro/WSIT/wsit/wsit/test/e2e/testcases/wstrust/multiple/sts/sts.wsdl', retrying as a local file");
