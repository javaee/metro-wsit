 ...
 * generated in the wstrust.publickeyn.sts package. 
...
public class ObjectFactory {
    ...
    private final static QName _MessageBody_QNAME = new QName("http://schemas.microsoft.com/Message", "MessageBody");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wstrust.publickeyn.sts
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.microsoft.com/Message", name = "MessageBody")
