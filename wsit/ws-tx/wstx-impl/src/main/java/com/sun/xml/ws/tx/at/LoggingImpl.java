...
public class LoggingImpl implements Logging {
  ...
  private final static Localizer localizer = new Localizer();
    ...
    public String log(Logger logger, Class loggerClass, Level level, String msgId, Object args, Throwable t) {
        return log(logger, loggerClass, level, msgId, args==null?new Object[]{}:new Object[]{args}, t);
    }

    public String log(Logger logger, Class loggerClass, Level level, String msgId, Object[] args, Throwable t) {
      //if msgId==null args[0] cannot be null 
      String msg = msgId==null?args[0].toString():localizer.localize(messageFactory.getMessage(msgId, args));
