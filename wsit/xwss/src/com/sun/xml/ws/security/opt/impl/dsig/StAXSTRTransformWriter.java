...
public class StAXSTRTransformWriter implements XMLStreamWriter,StreamWriterData{
    ...
    public void writeAttribute(String localname, String value) throws XMLStreamException {
        if(!ignore){
            ...
            if(directReference){
                if(MessageConstants.WSSE_REFERENCE_ATTR_URI.equals(localname)){
    ...
    public void writeStartElement(String namespaceURI, String localName)  throws XMLStreamException {
        if(!ignore){
            if(first && MessageConstants.WSSE_SECURITY_TOKEN_REFERENCE_LNAME.equals(localName)  && MessageConstants.WSSE_NS.equals(namespaceURI) ){
                ignore = true;
                index ++;
                return;
            }
    ...
    public void writeStartElement(String prefix, String localName, String namespaceURI)  throws XMLStreamException {
        if(!ignore){
            ...
            if(first && MessageConstants.WSSE_SECURITY_TOKEN_REFERENCE_LNAME.equals(localName) && MessageConstants.WSSE_NS.equals(namespaceURI)){
                ...
                index ++;
                return;
            }else if(first && MessageConstants.WSSE_REFERENCE_LNAME.equals(localName)  && MessageConstants.WSSE_NS.equals(namespaceURI)){
                ignore = true;
                index ++;
                directReference = true;
                nextWriter.writeNamespace(prefix,namespaceURI);
                return;
            }else if(first && MessageConstants.KEYIDENTIFIER.equals(localName) && MessageConstants.WSSE_NS.equals(namespaceURI)){
                ignore = true;
                index++;
                nextWriter.writeNamespace(prefix,namespaceURI);
            }else{
            ...
            if(MessageConstants.WSSE_REFERENCE_LNAME.equals(localName) && MessageConstants.WSSE_NS.equals(namespaceURI)){
                index ++;
                directReference = true;
            }else if (MessageConstants.KEYIDENTIFIER.equals(localName) && MessageConstants.WSSE_NS.equals(namespaceURI)){
                index ++;
                nextWriter.writeNamespace(prefix, namespaceURI);
            }else {
                nextWriter.writeStartElement(prefix,localName,namespaceURI);
