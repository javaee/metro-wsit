/*
 * $Id: KeyResolver.java,v 1.27 2008/07/03 05:29:00 ofung Exp $
 */
...
//            }
            ...
            ctx = SessionManager.getSessionManager().getSecurityContext(scId, !context.isExpired());
        }
