...
public class EncryptionProcessor {
    ...
    public static void encrypt(FilterProcessingContext context) throws XWSSecurityException{
        ...
        if (PolicyTypeUtil.usernameTokenPolicy(keyBinding)) {
            ...
            includeIST = (ikb.INCLUDE_ALWAYS_TO_RECIPIENT.equals(tokenVersion) ||
                          ikb.INCLUDE_ALWAYS.equals(tokenVersion) ||
                          ikb.INCLUDE_ALWAYS_VER2.equals(tokenVersion) ||
                          ikb.INCLUDE_ALWAYS_TO_RECIPIENT_VER2.equals(tokenVersion)
                          );
