...
public class DoNotCacheConditionImpl
    extends com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionTypeImpl
    implements com.sun.xml.wss.saml.internal.saml11.jaxb10.DoNotCacheCondition, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallableObject, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.XMLSerializable, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.xml.wss.saml.internal.saml11.jaxb10.DoNotCacheCondition.class);
    }
    ...
    public com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallingContext context) {
        return new com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionImpl.Unmarshaller(context);
    }
...
+"Expression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\f\u0001q\u0000~\u0000(sq\u0000~\u0000\"t\u0000\u0013DoNotCacheCo"
+"nditiont\u0000%urn:oasis:names:tc:SAML:1.0:assertionsr\u0000\"com.sun.m"
...
+"\u0000~\u0000\tx"));
        ...
        extends com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.DoNotCacheConditionImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
