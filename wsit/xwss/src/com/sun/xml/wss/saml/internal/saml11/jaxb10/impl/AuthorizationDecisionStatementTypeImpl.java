    ...
    implements com.sun.xml.wss.saml.internal.saml11.jaxb10.AuthorizationDecisionStatementType, com.sun.xml.bind.JAXBObject, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallableObject, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.XMLSerializable, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.xml.wss.saml.internal.saml11.jaxb10.AuthorizationDecisionStatementType.class);
    }
    ...
    public com.sun.xml.wss.saml.internal.saml11.jaxb10.EvidenceType getEvidence() {
        return _Evidence;
    }

    public void setEvidence(com.sun.xml.wss.saml.internal.saml11.jaxb10.EvidenceType value) {
        _Evidence = value;
    }
    ...
    public com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallingContext context) {
        return new com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.AuthorizationDecisionStatementTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx3 = 0;
        final int len3 = ((_Action == null)? 0 :_Action.size());
        super.serializeBody(context);
        while (idx3 != len3) {
            if (_Action.get(idx3) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _Action.get(idx3 ++)), "Action");
            } else {
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx3 != len3) {
            if (_Action.get(idx3) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Action.get(idx3 ++)), "Action");
            } else {
                idx3 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx3 != len3) {
            if (_Action.get(idx3) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Action.get(idx3 ++)), "Action");
            } else {
                idx3 += 1;
            }
        }
...
+"tt\u0000%urn:oasis:names:tc:SAML:1.0:assertionsq\u0000~\u0000\u0010ppsq\u0000~\u0000\tppsq\u0000"
+"~\u0000\u000bpp\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft"
+"\u00002com.sun.xml.wss.saml.internal.saml11.jaxb10.Actionq\u0000~\u0000#sq\u0000"
+"~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018"
+"q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u00006com.sun.xml.wss.saml.internal.saml11.jaxb"
+"10.ActionTypeq\u0000~\u0000#sq\u0000~\u0000\tppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001esq\u0000~\u0000\u001ft"
+"\u0000\u0006Actionq\u0000~\u0000Fsq\u0000~\u0000\tppsq\u0000~\u0000\tq\u0000~\u0000\u0014psq\u0000~\u0000\u000bq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0010"
+"q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u00004com.sun.xml.wss.sa"
+"ml.internal.saml11.jaxb10.Evidenceq\u0000~\u0000#sq\u0000~\u0000\u000bq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0000pp"
+"sq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\tppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~"
+"\u0000\u001ft\u00008com.sun.xml.wss.saml.internal.saml11.jaxb10.EvidenceTyp"
+"eq\u0000~\u0000#sq\u0000~\u0000\tppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\bEvidenceq\u0000"
+"~\u0000Fq\u0000~\u0000\u001esq\u0000~\u0000\u0015ppsq\u0000~\u0000.ppsr\u0000)com.sun.msv.datatype.xsd.Enumera"
...
+"tatype/xsd/ConcreteType;L\u0000\tfacetNameq\u0000~\u0000 xq\u0000~\u00005q\u0000~\u0000Ft\u0000\fDecis"
+"ionTypesr\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcessor$Pres"
+"erve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000;\u0000\u0000sr\u0000#com.sun.msv.datatype.xsd.StringTy"
+"pe\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u00003q\u0000~\u00008t\u0000\u0006stringq\u0000~\u0000z\u0001q\u0000~\u0000|"
+"t\u0000\u000benumerationsr\u0000\u0011java.util.HashSet\u00baD\u0085\u0095\u0096\u00b8\u00b74\u0003\u0000\u0000xpw\f\u0000\u0000\u0000\u0010?@\u0000\u0000\u0000\u0000"
+"\u0000\u0003t\u0000\u0004Denyt\u0000\rIndeterminatet\u0000\u0006Permitxq\u0000~\u0000>sq\u0000~\u0000?q\u0000~\u0000xq\u0000~\u0000Fsq\u0000~"
+"\u0000\u001ft\u0000\bDecisiont\u0000\u0000sq\u0000~\u0000\u0015ppsq\u0000~\u0000.ppsr\u0000#com.sun.msv.datatype.xsd"
+".AnyURIType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00003q\u0000~\u00008t\u0000\u0006anyURIq\u0000~\u0000<q\u0000~\u0000>sq\u0000~\u0000?q\u0000"
+"~\u0000\u008cq\u0000~\u00008sq\u0000~\u0000\u001ft\u0000\bResourceq\u0000~\u0000\u0087sr\u0000\"com.sun.msv.grammar.Expres"
...
+"om/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u001b\u0001pq\u0000~\u0000\u0006q\u0000~\u0000%q\u0000~\u0000Pq\u0000~"
+"\u0000dq\u0000~\u0000\u0007q\u0000~\u0000\u000fq\u0000~\u0000\'q\u0000~\u0000Jq\u0000~\u0000Rq\u0000~\u0000^q\u0000~\u0000fq\u0000~\u0000\u0012q\u0000~\u0000(q\u0000~\u0000Kq\u0000~\u0000Sq\u0000~"
+"\u0000_q\u0000~\u0000gq\u0000~\u0000Gq\u0000~\u0000,q\u0000~\u0000Wq\u0000~\u0000kq\u0000~\u0000\u0005q\u0000~\u0000[q\u0000~\u0000\nq\u0000~\u0000Hq\u0000~\u0000\\q\u0000~\u0000\bx"));
        }
        ...
        extends com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.AuthorizationDecisionStatementTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  6 :
                        if (("Subject" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.AuthorizationDecisionStatementTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("Subject" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.AuthorizationDecisionStatementTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname, __atts);
                    ...
                    case  7 :
                        if (("Action" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            _getAction().add(((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.ActionImpl) spawnChildFromEnterElement((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.ActionImpl.class), 10, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Action" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                    ...
                    case  11 :
                        if (("AssertionIDReference" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            _Evidence = ((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.EvidenceTypeImpl) spawnChildFromEnterElement((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.EvidenceTypeImpl.class), 12, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                    ...
                    case  10 :
                        ...
                        if (("Evidence" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            _Evidence = ((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.EvidenceImpl) spawnChildFromEnterElement((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.EvidenceImpl.class), 13, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Evidence" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  8 :
                        ...
                        break;
                    case  6 :
                        spawnHandlerFromLeaveElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.AuthorizationDecisionStatementTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                    case  12 :
                        if (("Evidence" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                ...
                switch (state) {
                    case  8 :
                        if (("Namespace" == ___local)&&("" == ___uri)) {
                            _getAction().add(((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.ActionTypeImpl) spawnChildFromEnterAttribute((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.ActionTypeImpl.class), 9, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  6 :
                        spawnHandlerFromEnterAttribute((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.AuthorizationDecisionStatementTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  8 :
                        ...
                        break;
                    case  6 :
                        spawnHandlerFromLeaveAttribute((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.AuthorizationDecisionStatementTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                    case  5 :
                        if (("Resource" == ___local)&&("" == ___uri)) {
                            state = 6;
                ...
                try {
                    switch (state) {
                        case  8 :
                            ...
                            _getAction().add(((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.ActionTypeImpl) spawnChildFromText((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.ActionTypeImpl.class), 9, value)));
                            return ;
                        case  6 :
                            spawnHandlerFromText((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.AuthorizationDecisionStatementTypeImpl.this).new Unmarshaller(context)), 7, value);
                            return ;
                        case  1 :
                            state = 2;
                            eatText2(value);
