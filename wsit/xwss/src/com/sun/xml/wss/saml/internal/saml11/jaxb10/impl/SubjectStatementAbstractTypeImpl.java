...
public class SubjectStatementAbstractTypeImpl
    extends com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.StatementAbstractTypeImpl
    implements com.sun.xml.wss.saml.internal.saml11.jaxb10.SubjectStatementAbstractType, com.sun.xml.bind.JAXBObject, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallableObject, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.XMLSerializable, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.ValidatableObject
{

    protected com.sun.xml.wss.saml.internal.saml11.jaxb10.SubjectType _Subject;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.xml.wss.saml.internal.saml11.jaxb10.SubjectStatementAbstractType.class);
    }

    public com.sun.xml.wss.saml.internal.saml11.jaxb10.SubjectType getSubject() {
        return _Subject;
    }

    public void setSubject(com.sun.xml.wss.saml.internal.saml11.jaxb10.SubjectType value) {
        _Subject = value;
    }
    ...
    public com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallingContext context) {
        return new com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl.Unmarshaller(context);
    }
...
+"Namet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001bxq\u0000~\u0000\u0016t\u00003com.su"
+"n.xml.wss.saml.internal.saml11.jaxb10.Subjectt\u0000+http://java."
+"sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0006pp\u0000sr\u0000\u001fcom.sun.msv.gram"
+"mar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001ppsq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bq\u0000~"
+"\u0000\u000fpsq\u0000~\u0000\u0010q\u0000~\u0000\u000fpq\u0000~\u0000\u0013q\u0000~\u0000\u0017q\u0000~\u0000\u0019sq\u0000~\u0000\u001at\u00007com.sun.xml.wss.saml."
+"internal.saml11.jaxb10.SubjectTypeq\u0000~\u0000\u001esq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0010q\u0000~\u0000\u000fps"
...
+"pq\u0000~\u00005q\u0000~\u00004sq\u0000~\u0000\u001at\u0000\u0004typet\u0000)http://www.w3.org/2001/XMLSchema-"
+"instanceq\u0000~\u0000\u0019sq\u0000~\u0000\u001at\u0000\u0007Subjectt\u0000%urn:oasis:names:tc:SAML:1.0:"
+"assertionsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000"
...
+"pressionPool;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000!q\u0000~\u0000\nq\u0000~\u0000#q\u0000~\u0000\rq\u0000~\u0000$q\u0000~\u0000(q\u0000~\u0000\u0005x"));
        ...
        extends com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl.this;
        }
                ...
                switch (state) {
                    case  2 :
                        if (("NameIdentifier" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            _Subject = ((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectTypeImpl) spawnChildFromEnterElement((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectTypeImpl.class), 3, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("NameIdentifier" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            _Subject = ((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectTypeImpl) spawnChildFromEnterElement((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectTypeImpl.class), 3, ___uri, ___local, ___qname, __atts));
                    ...
                    case  4 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromEnterElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.StatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  1 :
                        if (("Subject" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            _Subject = ((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectImpl) spawnChildFromEnterElement((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectImpl.class), 4, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Subject" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        break;
                    case  0 :
                        spawnHandlerFromLeaveElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.StatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromEnterAttribute((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.StatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveAttribute((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.StatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  4 :
                            ...
                            return ;
                        case  0 :
                            spawnHandlerFromText((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.StatementAbstractTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectStatementAbstractTypeImpl.this).new Unmarshaller(context)), 1, value);
                            return ;
                    }
