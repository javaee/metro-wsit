    ...
    implements com.sun.xml.wss.saml.internal.saml11.jaxb10.SubjectLocality, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallableObject, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.XMLSerializable, com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.xml.wss.saml.internal.saml11.jaxb10.SubjectLocality.class);
    }
    ...
    public com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.UnmarshallingContext context) {
        return new com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityImpl.Unmarshaller(context);
    }
...
+"t\u0000\tIPAddressq\u0000~\u0000)q\u0000~\u0000+sq\u0000~\u0000\u000bppsq\u0000~\u0000\rq\u0000~\u0000\u0010psq\u0000~\u0000\u0011ppsr\u0000\"com.su"
+"n.msv.datatype.xsd.QnameType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0016q\u0000~\u0000\u001ct\u0000\u0005QNamesr"
+"\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcessor$Collapse\u0000\u0000\u0000\u0000\u0000"
+"\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u001fq\u0000~\u0000\"sq\u0000~\u0000#q\u0000~\u00006q\u0000~\u0000\u001csq\u0000~\u0000%t\u0000\u0004typet\u0000)http://www."
+"w3.org/2001/XMLSchema-instanceq\u0000~\u0000+sq\u0000~\u0000%t\u0000\u000fSubjectLocalityt"
+"\u0000%urn:oasis:names:tc:SAML:1.0:assertionsr\u0000\"com.sun.msv.gramm"
...
+"\tq\u0000~\u00001q\u0000~\u0000\fq\u0000~\u0000-x"));
        ...
        extends com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromEnterElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveElement((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("SubjectLocality" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("DNSAddress" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveAttribute((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  1 :
                            ...
                            spawnHandlerFromText((((com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityTypeImpl)com.sun.xml.wss.saml.internal.saml11.jaxb10.impl.SubjectLocalityImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
